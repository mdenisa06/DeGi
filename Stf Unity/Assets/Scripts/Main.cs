...
public class Main : MonoBehaviour
{
    ...
    public CanvasGroup levelUpUpgrades;
    public CanvasGroup dailyQuests;
...
//__________________________________________________________________________________________________________________________________________
    ...
    public void ChangeTabs(string id){
        ...
        {
            case "main":
                mainCanvas.gameObject.SetActive(true); // Activate it here first
                CanvasGroupChanger(true, mainCanvas);
                break;
            case "levelUp":
                levelUpUpgrades.gameObject.SetActive(true); // Same for others
                CanvasGroupChanger(true, levelUpUpgrades);
                break;
            case "DQ":
                dailyQuests.gameObject.SetActive(true);
                CanvasGroupChanger(true, dailyQuests);
                break;
        }
        ...
        void DisableAll()
        {
            ...
            levelUpUpgrades.gameObject.SetActive(false);
